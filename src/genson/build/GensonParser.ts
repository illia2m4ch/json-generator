...
import GensonParserListener from "./GensonParserListener.js";
import GensonParserVisitor from "./GensonParserVisitor.js";

// for running tests with parameters, TODO: discuss strategy for typed parameters in CI
// eslint-disable-next-line no-unused-vars
type int = number;

export default class GensonParser extends Parser {
	...
	public static readonly RULE_genson = 0;
	...
	public static readonly ruleNames: string[] = [
		"genson", "simpleValue", "obj", "pair", "arr", "placeholder", "placeholderValue", 
		"value", "args", "arg", "parameterValue",
	];
	public get grammarFileName(): string { return "GensonParser.g4"; }
	public get literalNames(): (string | null)[] { return GensonParser.literalNames; }
	public get symbolicNames(): (string | null)[] { return GensonParser.symbolicNames; }
	public get ruleNames(): string[] { return GensonParser.ruleNames; }
	public get serializedATN(): number[] { return GensonParser._serializedATN; }
	...
	constructor(input: TokenStream) {
		super(input);
		this._interp = new ParserATNSimulator(this, GensonParser._ATN, GensonParser.DecisionsToDFA, new PredictionContextCache());
	}
	// @RuleVersion(0)
	public genson(): GensonContext {
		let localctx: GensonContext = new GensonContext(this, this._ctx, this.state);
		this.enterRule(localctx, 0, GensonParser.RULE_genson);
		try {
	...
	public simpleValue(): SimpleValueContext {
		...
		this.enterRule(localctx, 2, GensonParser.RULE_simpleValue);
		try {
			this.state = 33;
			...
			case 3:
				...
				{
				this.state = 26;
				this.match(GensonParser.NUMBER);
				}
				break;
			case 15:
	...
	public obj(): ObjContext {
		...
		this.enterRule(localctx, 4, GensonParser.RULE_obj);
		let _la: number;
		try {
			this.state = 48;
			this._errHandler.sync(this);
	...
	public pair(): PairContext {
		...
		this.enterRule(localctx, 6, GensonParser.RULE_pair);
		try {
			this.enterOuterAlt(localctx, 1);
			{
			this.state = 50;
	...
	public placeholder(): PlaceholderContext {
		...
		this.enterRule(localctx, 10, GensonParser.RULE_placeholder);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public value(): ValueContext {
		...
		this.enterRule(localctx, 14, GensonParser.RULE_value);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public args(): ArgsContext {
		...
		this.enterRule(localctx, 16, GensonParser.RULE_args);
		let _la: number;
		try {
			this.enterOuterAlt(localctx, 1);
			{
	...
	public static get _ATN(): ATN {
		if (!GensonParser.__ATN) {
			GensonParser.__ATN = new ATNDeserializer().deserialize(GensonParser._serializedATN);
		}

		return GensonParser.__ATN;
	}


	static DecisionsToDFA = GensonParser._ATN.decisionToState.map( (ds: DecisionState, index: number) => new DFA(ds, index) );

}

export class GensonContext extends ParserRuleContext {
	constructor(parser?: GensonParser, parent?: ParserRuleContext, invokingState?: number) {
	...
	public EOF(): TerminalNode {
		return this.getToken(GensonParser.EOF, 0);
	}
    public get ruleIndex(): number {
    	return GensonParser.RULE_genson;
	}
	public enterRule(listener: GensonParserListener): void {
	    if(listener.enterGenson) {
	 		listener.enterGenson(this);
		}
	}
	public exitRule(listener: GensonParserListener): void {
	    if(listener.exitGenson) {
	 		listener.exitGenson(this);
		}
	}
	// @Override
	public accept<Result>(visitor: GensonParserVisitor<Result>): Result {
		if (visitor.visitGenson) {
			return visitor.visitGenson(this);
		} else {
...
export class SimpleValueContext extends ParserRuleContext {
	...
	public NUMBER(): TerminalNode {
		return this.getToken(GensonParser.NUMBER, 0);
	}
	public obj(): ObjContext {
	...
	public TRUE(): TerminalNode {
		return this.getToken(GensonParser.TRUE, 0);
	}
	public FALSE(): TerminalNode {
		return this.getToken(GensonParser.FALSE, 0);
	}
	public NULL(): TerminalNode {
		return this.getToken(GensonParser.NULL, 0);
	}
	public placeholder(): PlaceholderContext {
		return this.getTypedRuleContext(PlaceholderContext, 0) as PlaceholderContext;
	}
    public get ruleIndex(): number {
    	return GensonParser.RULE_simpleValue;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class ObjContext extends ParserRuleContext {
	...
	public LCURL(): TerminalNode {
		return this.getToken(GensonParser.LCURL, 0);
	}
	...
	public RCURL(): TerminalNode {
		return this.getToken(GensonParser.RCURL, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(GensonParser.COMMA);
	}
	public COMMA(i: number): TerminalNode {
		return this.getToken(GensonParser.COMMA, i);
	}
    public get ruleIndex(): number {
    	return GensonParser.RULE_obj;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class ArrContext extends ParserRuleContext {
	...
	public LSQUARE(): TerminalNode {
		return this.getToken(GensonParser.LSQUARE, 0);
	}
	...
	public RSQUARE(): TerminalNode {
		return this.getToken(GensonParser.RSQUARE, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(GensonParser.COMMA);
	}
...
export class PlaceholderContext extends ParserRuleContext {
	...
	public LPLACEHOLDER(): TerminalNode {
		return this.getToken(GensonParser.LPLACEHOLDER, 0);
	}
	...
	public RPLACEHOLDER(): TerminalNode {
		return this.getToken(GensonParser.RPLACEHOLDER, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(GensonParser.COMMA);
	}
    ...
    public get ruleIndex(): number {
    	return GensonParser.RULE_placeholder;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class PlaceholderValueContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return GensonParser.RULE_placeholderValue;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class ValueContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return GensonParser.RULE_value;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class ArgsContext extends ParserRuleContext {
	...
	public LPAREN(): TerminalNode {
		return this.getToken(GensonParser.LPAREN, 0);
	}
	...
	public RPAREN(): TerminalNode {
		return this.getToken(GensonParser.RPAREN, 0);
	}
	public COMMA_list(): TerminalNode[] {
	    	return this.getTokens(GensonParser.COMMA);
	}
...
export class ArgContext extends ParserRuleContext {
	...
	public IDENTIFIER(): TerminalNode {
		return this.getToken(GensonParser.IDENTIFIER, 0);
	}
	public ASSIGNMENT(): TerminalNode {
		return this.getToken(GensonParser.ASSIGNMENT, 0);
	}
	public parameterValue(): ParameterValueContext {
		return this.getTypedRuleContext(ParameterValueContext, 0) as ParameterValueContext;
	}
    public get ruleIndex(): number {
    	return GensonParser.RULE_arg;
	}
	public enterRule(listener: GensonParserListener): void {
...
export class ParameterValueContext extends ParserRuleContext {
    ...
    public get ruleIndex(): number {
    	return GensonParser.RULE_parameterValue;
	}
	public enterRule(listener: GensonParserListener): void {
